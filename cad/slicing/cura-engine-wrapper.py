...
sys.path.append(os.path.abspath("B:\\programs\\Program Files\\UltiMaker Cura 5.9.0"))
...
class DummyApp(Application):
    ...
    def __init__(self):
        Application.__init__(self, name = ApplicationMetadata.CuraAppName,
...
plugin_registry = PluginRegistry(dummyApp)
