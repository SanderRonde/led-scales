...
Physical build with the web controller driving the LEDs:

![LED scales in motion](.github/images/led-scales.gif)

CAD layout examples (tile patterns generated by this project):

![CAD scale patterns](.github/images/led-scales-cad.png)

A higher-quality copy of the clip lives in [`.github/images/led-scales.mp4`](.github/images/led-scales.mp4).
